...
export const metadata: Metadata = {
  ...
  description: 'اكتشف تقييمات حقيقية للمباني والشقق في مصر من مستأجرين مجهولي الهوية: الزحمة، الأمان، الجيران، تعاون المالك والخدمات. اعرف الحقيقة قبل ما تتعاقد.',
  openGraph: {
    title: 'RentRate — اعرف الحقيقة قبل ما تتعاقد',
