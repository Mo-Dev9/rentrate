    ...
    <>
      ...
      <main className="flex-1 mx-auto max-w-3xl px-4 py-10">
        ...
        <section className="mb-10">
          ...
          <p className="leading-8 text-[var(--color-text-secondary)]">
            RentRate منصة إلكترونية مصرية تتيح للمستأجرين تقييم الشقق والمباني السكنية بشكل مجهول الهوية على ستة معايير: الطرقبة، الرطوبة، تعاون المالك، الجيران، الأمان، والإضاءة. هدفنا واحد: أن يعرف كل مستأجر الحقيقة قبل أن يوقّع العقد.
          </p>
        </section>
