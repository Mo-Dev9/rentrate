          ...
          <div className="space-y-12">
            ...
            <div className="relative">
              ...
              <div className="md:pr-8">
                ...
                <p className="text-[var(--color-text-secondary)] leading-relaxed mb-3">
                  RentRate مش مجرد موقع تقييم — هو دليلك الصادق. هنا السكان بيتقيموا المبنى على 11 معيار حقيقي: الزحمة، نظافة المبنى، تعاون المالك، إنارة الشارع، أمان الحي، حالة الشقة، الخدمات، الإزعاج، المصعد، الصيانة والتهوية.
                </p>
                <p className="text-[var(--color-text-secondary)] leading-relaxed">
