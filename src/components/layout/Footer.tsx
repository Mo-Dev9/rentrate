      ...
      <div className="mx-auto max-w-5xl px-4 py-10">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <nav className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
            ...
            <Link href="/search?add=true" className="text-sm text-white/70 hover:text-[var(--color-accent)] hover:underline underline-offset-4 transition-colors">
              شارك تجربتك
            </Link>
          ...
          <div className="flex items-center gap-4">
            <a href="https://instagram.com/rentrate.eg" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-[var(--color-accent)] transition-colors" aria-label="Instagram">
            ...
            <a href="https://tiktok.com/@rentrate.eg" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-[var(--color-accent)] transition-colors" aria-label="TikTok">
            ...
            <a href="https://facebook.com/RentRate.eg" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-[var(--color-accent)] transition-colors" aria-label="Facebook">
